...
import { initializeIcons, Text, Stack, TextField } from "@fluentui/react";
    ...
    <div style={mainStyles}>
      ...
      <Stack tokens={tokens}>
        ...
        <Stack>
          ...
          <Text variant="medium">
            Here's an example of how sections can be used to configure inputs.
          </Text>
        </Stack>
        <Stack horizontal tokens={stackTokens}>
          <PrimaryButton iconProps={addIcon}>Add Entry</PrimaryButton>
          <TextField
            width="200px"
            type="search"
